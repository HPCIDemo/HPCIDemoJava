...
@WebServlet("/IframeSplitModeServlet")
public class IframeSplitModeServlet extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (flag.equals("config")) {
			...
			out.print("sid;" + mapConfig.get("sid") + "," + "ccOnlyLocationNameSpitMode;" + mapConfig.get("ccOnlyLocationNameSpitMode") + ","
					+ "cvvOnlyLocationNameSpitMode;" + mapConfig.get("cvvOnlyLocationNameSpitMode") + ","
